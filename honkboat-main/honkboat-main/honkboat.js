...
client.on('message', async message => {
    ...
    if (command === 'help') {
        ...
        .addField(`Commands [ 7 ]`, "`honk, reportbug, invite, uptime, stats, vote, support`")
    ...
    if (command === 'honk') {
        ...
        var honkapi = await fetch("https://api.tazhys.gg/honk/index.php").then(response => response.text());
    ...
    if (command === 'support') {
        ...
        .setDescription(`${info} Support Server: [Click Me!](https://discord.gg/NhDHmEc)`)
    }
